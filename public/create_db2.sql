...
CREATE TABLE `appove` (
  ...
  `dateandtime` timestamp default current_timestamp,
  PRIMARY KEY (`newsid`),
  KEY `appove_ibfk_1` (`sendid`),
  KEY `appove_ibfk_2` (`receiveid`),
  CONSTRAINT `appove_ibfk_1` FOREIGN KEY (`sendid`) REFERENCES `user` (`userid`),
  CONSTRAINT `appove_ibfk_2` FOREIGN KEY (`receiveid`) REFERENCES `user` (`userid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
insert into appove(sendid ,receiveid,content)
values(1,2,'你好我想加你为好友');